...
Drawable::Drawable(OpenGLContext* context)
    : m_count(-1), m_countOpq(-1), m_countTrans(-1), m_bufIdx(), m_bufPos(), m_bufNor(), m_bufCol(), m_bufUV(),
...
void Drawable::destroyVBOdata()
{
    ...
    m_idxGenerated = m_posGenerated = m_norGenerated = m_colGenerated = m_UVGenerated =
